...
import es.upm.dit.prog.practica3.Coordenada;
import es.upm.dit.prog.practica3.Lectura;
import es.upm.dit.prog.practica3.Localizacion;
import es.upm.dit.prog.practica3.Seguridad;
import es.upm.dit.prog.practica3.WiFi;
...
public class PruebaLocalizacion {
	...
	public static void main(String[] args) {
		...
		Localizacion loc = new Localizacion (new Coordenada (0,0), 10); 				//error porque sale todo null
